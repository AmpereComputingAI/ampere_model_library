...
#        print("PADDING: {}".format(pad_to))
    ...
    def get_seq_len(self, seq_len):
        ...
        seq_len = torch.div((seq_len + self.hop_length - 1), self.hop_length, rounding_mode="trunc")
        seq_len = torch.div((seq_len + self.frame_splicing - 1), self.frame_splicing, rounding_mode="trunc")
        return seq_len
