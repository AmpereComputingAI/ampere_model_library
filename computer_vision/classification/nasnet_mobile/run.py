...
def parse_args():
    parser = argparse.ArgumentParser(description="Run Nasnet Mobile model.")
...
def run_pytorch_fp(batch_size, num_of_runs, timeout, images_path, labels_path):
    ...
    runner = PyTorchRunner(torchvision.models.__dict__["mnasnet1_0"](pretrained=True), classification_model=True)
