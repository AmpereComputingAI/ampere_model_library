...
This folder contains the script to run GoogLeNet on ImageNet classification task in PyTorch framework.\
Variant supplied below in fp32 precision accepts input of shape 224x224.

The original paper on the architecture is available here: https://arxiv.org/abs/1409.4842
