...
def run_torch_fp32(model_path, batch_size, num_of_runs, timeout, dataset_path, jit_freeze):
    ...
    runner = PyTorchRunner(dlrm, jit_freeze)
...
def main():
    ...
    if args.framework == "pytorch":
        if args.precision == "fp32":
            run_torch_fp32(
                args.model_path, args.batch_size, args.num_runs, args.timeout, args.dataset_path, args.jit_freeze
            )
        else:
